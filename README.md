...
| <a name="input_s3_additional_policy_statements"></a> [s3\_additional\_policy\_statements](#input\_s3\_additional\_policy\_statements) | Additional policies that need to be attached to the S3 bucket. Detailed below. | `null` | `list(object)`| no |

## s3_additional_policy_statement
