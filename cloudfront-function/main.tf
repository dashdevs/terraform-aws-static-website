...
locals {
  cloudfront_function_configs = {
    ...
    basic_auth = {
      ...
      password = try(var.cloudfront_function_config.basic_auth.password, null) != null ? var.cloudfront_function_config.basic_auth.password : random_password.this[0].result
    }
  }
}
...
resource "aws_cloudfront_function" "this" {
  ...
  key_value_store_associations = local.cloudfront_function_configs.usage == "basic_auth" ? [aws_cloudfront_key_value_store.this[0].arn] : []
}
